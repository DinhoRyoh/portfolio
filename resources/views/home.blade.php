...
<div class="space"></div>
<p>Je suis une formation développeur full stack à l'it akademy.<br>
Je suis diplômé d'un DUT informatique, j'ai toujours été branché technologies.
Je travaille actuellement chez Optimis à Lyon.<br>
Ce site a pour but de présenter mon parcours, mes projets et mes experiences.</p>
<div class="space"></div>
</div>
...
<div class="info">
  ...
  <span><i style="color:lightpink" class="fa fa-phone-square" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;07 64 08 16 88</span><br>
